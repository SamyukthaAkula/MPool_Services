...
namespace MPool.WS.Users.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        (OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            using (var obj = new MPOOL_HackathonEntities())
            {

                LOGIN entry = obj.LOGINS.Where
                <LOGIN>(record => 
                record.UserName == context.UserName && 
                record.UserPassword == context.Password).FirstOrDefault();
